...
public class Product_Controller {
 ...
 // Endpoint to retrieve all products
	...
	/* @CrossOrigin(origins = "http://127.0.0.1:5500") */
	/*
	 * @PostMapping("/updateProduct") public ResponseEntity<Product_Entity>
	 * updateProduct(@PathVariable("id") int id, @RequestBody Product_Entity
	 * product) { Product_Entity updatedProduct = product_Service.updateProduct(id,
	 * product); if (updatedProduct != null) { return new
